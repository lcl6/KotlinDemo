...
class ShimmerLayout : FrameLayout {
    ...
    private val DEFAULT_ANGLE: Byte = 20

    private val MIN_ANGLE_VALUE: Byte = -45
    private val MAX_ANGLE_VALUE: Byte = 45
    private val MIN_MASK_WIDTH_VALUE: Byte = 0
    private val MAX_MASK_WIDTH_VALUE: Byte = 1

    private val MIN_GRADIENT_CENTER_COLOR_WIDTH_VALUE: Byte = 0
    private val MAX_GRADIENT_CENTER_COLOR_WIDTH_VALUE: Byte = 1
    ...
    private fun getMaskBitmap(): Bitmap? {
        if (maskBitmap == null) {
            maskBitmap = createBitmap(this.maskRect!!.width(), height)
        }
